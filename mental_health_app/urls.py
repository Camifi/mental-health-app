...
urlpatterns = [
    ...
    path('patient/profile', user_views.edit_patient_profile, name='patient_profile'),
...
# Añadir las rutas para servir los archivos estáticos y de media durante el desarrollo
if settings.DEBUG:
